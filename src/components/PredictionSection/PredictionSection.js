		...
		<div className="predictionSection">
			<div className="predictionSection__range">
				...
				<div className="predictionSection__rangeScores">
					<p><span>Age</span>: The person's age in years</p>
					<p><span>Sex</span>: The person's sex (1 = male, 0 = female)</p>
					<p>
						<span>Cp</span>: The chest pain experienced (Value 1: typical angina, Value 2: atypical angina, Value 3: non-anginal
						pain, Value 4: asymptomatic)
					</p>
					<p><span>Trestbps</span>: The person's resting blood pressure (mm Hg on admission to the hospital)</p>
					<p><span>Chol</span>: The person's cholesterol measurement in mg/dl</p>
					<p><span>Fbs</span>: The person's fasting blood sugar (&gt; 120 mg/dl, 1 = true; 0 = false)</p>
					<p>
						<span>Restecg</span>: Resting electrocardiographic measurement (0 = normal, 1 = having ST-T wave abnormality, 2 = showing
						probable or definite left ventricular hypertrophy by Estes' criteria)
					</p>
					<p><span>Thalach</span>: The person's maximum heart rate achieved</p>
					<p><span>Exang</span>: Exercise induced angina (1 = yes; 0 = no)</p>
					<p>
						<span>Oldpeak</span>: ST depression induced by exercise relative to rest ('ST' relates to positions on the ECG plot.)
					</p>
					<p>
						<span>Slope</span>: the slope of the peak exercise ST segment (Value 1: upsloping, Value 2: flat, Value 3: downsloping)
					</p>
					<p><span>Ca</span>: The number of major vessels (0-3)</p>
					<p><span>Thal</span>: A blood disorder called thalassemia (3 = normal; 6 = fixed defect; 7 = reversable defect)</p>
				</div>
			</div>
				...
				<div
					className={
						result.toLowerCase() === 'positive'
							? 'predictionSection__resultPositive'
							: 'predictionSection__resultNegative'
					}
				>
